...
<!--header-->
            ...
            <ul class="navbar-nav me-auto ml-2 mb-lg-0">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                  ...
                  <li><a class="dropdown-item active" href="cursos">Cursos</a></li>
                </ul>
              </li>
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
    ...
    <div  class=" row col-sm-12"  >
      <img class="img-seminario" src="images/cursos.gif">    
     </div>


     <div class="animate__animated animate__jackInTheBox animate__delay-3s">
     <h2 style=" 
    font-weight: 1000;
    text-align: center;
    justify-content: center;
    color:#A3A6A6 ;margin-bottom:50px;
    size: 50px;">Imagenes de los cursos presenciales realizados</h2>
</div>

       <div class="row col-sm-12">
         @foreach($Cursos as $curso)
         <div class="col-md-4 col-sm-12 animate__animated animate__jackInTheBox animate__delay-3s">
           <section class="contain">
       
     
  
           <figure> 
             <img src="/images/{{$curso->imagen}}">
        ...
        <div class="row">
          ...
          <div class="col-md-3 mx-auto">
            ...
            <ul class="list-unstyled">
              ...
              <li>
                <a href=diseno-web.html>Talleres</a>
              </li>
              <li>
                <a href="marketing-digital.html">Cursos</a>
              </li>
              <li>
                <a href="capacitacion-tecnica.html">Convenios</a>
              </li>
              <li>
                <a href="capacitacion-tecnica.html">Videos</a>
              </li>
            </ul>
              </li>
