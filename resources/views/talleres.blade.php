...
<nav class=" navbar navbar-expand-lg navbar-dark bg-dark " style="  border-bottom-left-radius:5px; border-bottom-right-radius:5px ">
            ...
            <ul class="navbar-nav me-auto ml-2 mb-lg-0">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                  ...
                  <li><a class="dropdown-item active" href="talleres">Talleres</a></li>
    ...
    <div class=" row col-sm-12">
      <img style="text-align: center;" class="img-taller" src="images/taller.gif">    
     </div>
     ...
     <div class=" row col-sm-12">
        ...
        <div class="lema">
     <p>Los talleres que realizamos es en beneficio de la comunidad de la ciudad de EL ALTO 
        y de esa manera fortalecer los conocimientos de nuestra sociedad en cuanto a la Educación.
     </p>
    </div>
    </div>
     ...
     <div class=" row col-sm-12">
      ...
      <div class=" animate__animated animate__fadeInDown animate__delay-2s col-md-6 col-sm-12 "  >
        <div class="lema">
          <p>Los talleres van relacionados con las necesidades de los Docentes y de los estudiantes. 
         </p>
    </div>
    </div>
    ...
    <div class="imagen">
     ...
     <img src="images/tallerimg.png">
     </div>
     </div>
     

    </div>
     <div class="titu"> <h2 style="text-align: center; color:slategray;margin-top:20px; margin-bottom: 220px;">Talleres Realizados</h2>   
</div>
     ...
     @foreach ($tallers as $taller)
      <div class=" animate__animated animate__fadeInDown animate__delay-2s col-md-4 col-sm-12 "  >
          ...
          <div class="contenedor" >
            <figure >
              <img src="images/{{$taller->imagen}}" alt=""> 
              <div class="capa">
                <h3>{{$taller->nombre}}</h3>
        ...
        <div class="row">
          ...
          <div class="col-md-3 mx-auto">
            ...
            <ul class="list-unstyled">
              ...
              <li>
                <a href="/talleres">Actividades</a>
              </li>
              <li>
                <a href="/cursos">Productos</a>
              </li>
              <li>
